...
def paaohjelma():
    ...
    knimi = input("Anna kirjoitettavan tiedoston nimi: ") # L09T4T1.txt
    ...
    while (toiminto != 0):
        ...
        if toiminto == 1:
            if (indexe == None):
                luvut = L09T4Kirjasto.lueTiedosto(lnimi, luvut)
                indexe = len(luvut) - 1
            else:
                indexi += 2
            ...
            tulot.append(L09T4Kirjasto.summa(luku1, luku2))
            print("Tulos lisätty listaan.")
        elif toiminto == 3:
            tulot.append(L09T4Kirjasto.osamaara(luku1, luku2))
            print("Tulos lisätty listaan.")
        elif toiminto == 0:
            if not tulot:
                print("Ei tallennettavia tietoja, tiedostoa ei tallennettu.")
            else:
                L09T4Kirjasto.talennaTiedosto(knimi, tulot)
            luvut.clear()
            tulot.clear()
        else:
